              ...
              child: Column(
                ...
                children: [
                  ...
                  PinCodeTextField(
                      ...
                      length: 6,
                      onChanged: (text) {
                        cubit.phoneVerificationCode = text;
                      }),
                  SizedBox(
                    height: 51.5.h,
                  ),
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                        onPressed: cubit.phoneVerificationCode.length < 6
                            ? null
                            : () {
                                Navigator.pop(context);
                              },
                        child: Text(
                          ...
                          style: TextStyle(
                              fontSize: 23,
                              fontWeight: FontWeight.bold,
                              color: cubit.phoneVerificationCode.length < 6
                                  ? Colors.grey[700]
                                  : Colors.white),
                        ),
                        style: ButtonStyle(
                            ...
                            backgroundColor: MaterialStateProperty.all(
                                cubit.phoneVerificationCode.length < 6
                                    ? Colors.grey
                                    : Colors.blue[300]))),
                  )
                ],
